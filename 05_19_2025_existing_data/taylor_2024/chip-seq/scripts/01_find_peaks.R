...
hs_genes <- fread("/gs/gsfs0/users/rscharf/steidl_lab/heparan-sulfates/useful_stuff/HS_relevant_genes.csv")
...
# NEXT
# Visualize in IGV
# Look at PU.1 binding motifs in these regions of the HS genes 
